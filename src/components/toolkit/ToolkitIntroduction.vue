...
<template>
  <div class="w-full container mx-auto px-2 grid grid-cols-2 gap-4">
    <ToolkitPhaseNavigation :phase="phase" class="col-span-2"></ToolkitPhaseNavigation>
    <ToolkitHeading text="Introduction" class="md:pt-4 col-span-2"></ToolkitHeading>
    ...
    <Card class="overflow-hidden col-span-2 md:col-span-1">
      <template #header>
        <img
    ...
    <Card v-if="projectPlan.previousEngagement === 'Unknown'" class="col-span-2 md:col-span-1">
      <template #subtitle>
        <p>
    ...
    <Card
      class="overflow-hidden col-span-2 md:col-span-1"
    ...
    <Card class="col-span-2">
      <template #title>
        <h1 class="font-black text-xl">Links to Participatory Research opportunities</h1>
      </template>
      <template #content>
        <ul class="list-disc pl-5">
          <li>
            <a href="https://www.lancaster.ac.uk/research/participate-in-research/" target="_blank"
    ...
    <Card class="col-span-2 md:col-span-1 min-h-120">
      <template #title>
        <h1 class="font-black text-xl">Case Studies</h1>
      </template>
      <template #content>
        <p>
          Take a look at the <RouterLink to="/case-studies">Case Studies</RouterLink> for further
          inspiration.
        </p>
        <div class="max-w-100"><CaseStudyLink></CaseStudyLink></div>
      </template>
    </Card>
    <p class="col-span-2 mt-4 text-right">
